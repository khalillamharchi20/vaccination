...
class date_vaccination(models.Model):
    date_v = models.DateField(null=True, blank=True)
...
class pation(models.Model):
    ...
    nom_centre = models.ForeignKey(centre_vaccination , max_length=300, null=True, blank=True, on_delete=models.SET_NULL)
    date_faccination1 = models.DateField(null=True, blank=True)
    date_faccination2 = models.DateField(null=True, blank=True)
    def __str__(self):
